...
;(function(){
    ...
    var Sensor = function(isShell) {

        this._zone = null;
        this._shell = isShell;
        this._multi = isShell ? [] : null; // list of sensors to process through sensor api
        this._callback = null;
        this._context = null;
        this._max = null;
        this._host = null;
    ...
    Sensor.prototype.toArray = function(){
            return this._shell ? this._multi : [];
    };
    ...
    Sensor.prototype.auto = Sensor.prototype.autorun = function() {
        ...
        var sensors = this._shell ? this._multi : [];
    ...
    Sensor.prototype.merge = Sensor.prototype.next =function(mergeTopic) {
        ...
        var mergeLoc = this._mergeLoc = this._zone.demandData('auto:' + (catbus.uid + 1));
    ...
    var Location = function(name) {
        ...
        this._shell = false;
        this._multi = []; // list of locations to put through api
        this._id = ++catbus.uid;
    ...
    Location.prototype.createSensor = Location.prototype.on = Location.prototype.sensor = function(topicOrTopics){
        ...
        if(!this._shell)
            throw new Error('not loc facade!');

        topicOrTopics = topicOrTopics || 'update';
        topic_list = toNameArray(topicOrTopics);
        loc_list = this._multi;

        sensor = this._createSensor(true);
    ...
    Location.prototype._createSensor = function(isShell){
        var sensor = new Sensor(isShell);
